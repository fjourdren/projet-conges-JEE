                ...
                <div class="card">
                    <div style="padding: 16px">
                        <div class="form-group row">
                            <label class="col-sm-12 col-form-label"><%= dayoff.getEmployee().getFirstName() + " " + dayoff.getEmployee().getLastName() %>
                            </label>

                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Date création de la demande
                                : <%= dayoff.getDateCreation() %>
                            </label>

                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Date début du congé : <%= dayoff.getDateStart() %>
                            </label>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Date début du congé : <%= dayoff.getDateEnd() %>
                            </label>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Commentaire
                                : <%= (dayoff.getCommentEmployee() == null) ? "" : dayoff.getCommentEmployee() %>
                            </label>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <input type="radio" id="choix-rh-input-validate" name="choix-rh"
                                       value="ACCEPTED" <% if (dayoff.getStatus()==DayoffStatus.ACCEPTED) { %>
                                       checked <% } %>>
                            ...
                            <div class="col-sm-4">
                                <input type="radio" id="choix-rh-input-wait" name="choix-rh"
                                       value="WAITING"<% if (dayoff.getStatus()==DayoffStatus.WAITING) { %>
                                       checked <% } %>>
                            ...
                            <div class="col-sm-4">
                                <input type="radio" id="choix-rh-input-refused" name="choix-rh"
                                       value="REFUSED"<% if (dayoff.getStatus()==DayoffStatus.REFUSED) { %>
                                       checked <% } %>>
